...
void create_dirs()
{
    std::filesystem::path results_folder_path = "C:\\Users\\79171\\Desktop\\lab_2\\lab_2pp\\results_np";
    std::filesystem::path result_matrix_folder_path = "C:\\Users\\79171\\Desktop\\lab_2\\lab_2pp\\results_np\\result_matrix";
    std::filesystem::path result_computings_folder_path = "C:\\Users\\79171\\Desktop\\lab_2\\lab_2pp\\results_np\\result_computing";
    std::filesystem::path data_folder_path = "C:\\Users\\79171\\Desktop\\lab_2\\lab_2pp\\data_np";
...
int main()
{
    ...
    for (auto size : sizes)
    {
        for (size_t i = 0; i < 10; i++)
        {
            ...
            write_matrix_to_file(std::format("C:\\Users\\79171\\Desktop\\lab_2\\lab_2pp\\data_np\\matrix_1_{}_{}.txt", size, i), m1, size);
            write_matrix_to_file(std::format("C:\\Users\\79171\\Desktop\\lab_2\\lab_2pp\\data_np\\matrix_2_{}_{}.txt", size, i), m2, size);
            write_matrix_to_file(std::format("C:\\Users\\79171\\Desktop\\lab_2\\lab_2pp\\results_np\\result_matrix\\result_matrix_{}_{}.txt", size, i), res, size);
            save_to_json(std::format("C:\\Users\\79171\\Desktop\\lab_2\\lab_2pp\\results_np\\result_computing\\matrix_{}_{}.json", size, i), time, size);
        }
    }
}